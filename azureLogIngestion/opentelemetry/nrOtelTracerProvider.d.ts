...
import { BasicTracerProvider } from '@opentelemetry/tracing/build/src/BasicTracerProvider';
import { SpanLimits, TracerConfig } from '@opentelemetry/tracing/build/src//types';
/**
 * This class represents a basic tracer.
 */
export declare class NrOtelTracerProvider extends BasicTracerProvider {
  ...
  getActiveSpanProcessor(): import("@opentelemetry/tracing/build/src/SpanProcessor").SpanProcessor;
}
