...
| [AppPerformanceCounters](https://docs.microsoft.com/en-us/azure/azure-monitor/reference/tables/appperformancecounters) | Yes | [Metrics](https://docs.newrelic.com/docs/telemetry-data-platform/ingest-apis/introduction-metric-api/#find-data) |
